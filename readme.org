...
|           | lem-post-cancel                        | Kill new-post buffer/window. Does not POST content to Mastodon.    |
|           | lem-post-comment-mode                  | Minor mode for submitting comments to lemmy.                       |
|           | lem-post-compose                       | Compose a new post.                                                |
|           | lem-post-mode                          | Minor mode for submitting posts to lemmy.                          |
|           | lem-post-new-post-simple               | Create and submit new post.                                        |
|           | lem-post-read-title                    | Read post title.                                                   |
|           | lem-post-read-url                      | Read post URL.                                                     |
|           | lem-post-reply                         | Reply to a post or comment.                                        |
|           | lem-post-reply-simple                  | Reply to post or comment at point.                                 |
|           | lem-post-select-community              | Select community to post to.                                       |
|           | lem-post-set-post-language             | Prompt for a language and set `fedi-post-language'.                |
|           | lem-post-submit                        | Submit the post to lemmy.                                          |
|           | lem-post-toggle-nsfw                   | Toggle `fedi-post-content-nsfw'.                                   |
