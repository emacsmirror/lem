...
- =M-p= - =lem-ui-prev-top-level= - navigate to the previous top-level comment
- =M-n= - =lem-ui-next-top-level= - navigate to the next top-level comment
- =M-u= - =lem-ui-branch-top-level= - move to the comment at the top of branch point is in


- =f= - =lem-ui-comment-tree-fold= - toggle folding of current comment, and all its children (but not its parents)
...
| M-n       | lem-ui-next-top-level                  | Move to next top level comment.                                           |
| <backtab> | lem-ui-prev-tab-item                   | Jump to prev tab item.                                                    |
| M-p       | lem-ui-prev-top-level                  | Move to previous top level comment.                                       |
...
|           | lem-ui-unfold-buffer                   | Unfold all comment branches in the current buffer.                        |
