...
| n       | lem-next-item                          |                                                                |
| p       | lem-prev-item                          |                                                                |
|         | lem-ui--follow-link-at-point           |                                                                |
|         | lem-ui-choose-sort                     | Read a sort type and load it.                                  |
|         | lem-ui-choose-sort-or-type             | Read a sort type and load it.                                  |
...
|         | lem-ui-dislike-comment-at-point        | Dislike (downvote) item at point.                              |
...
|         | lem-ui-like-item-at-point              | Like (upvote) item at point.                                   |
